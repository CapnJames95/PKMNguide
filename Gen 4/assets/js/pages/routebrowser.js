function buildRouteBrowserPage() {
  ...
  var RB_GAME_LABELS = {FR:'💎 Diamond',LG:'🌸 Pearl',R:'⚙ Platinum',S:'💛 HeartGold',E:'🤍 SoulSilver'};
  var RB_GAME_COLORS = {FR:'var(--diamond)',LG:'var(--pearl)',R:'var(--platinum)',S:'var(--heartgold)',E:'var(--soulsilver)'};
